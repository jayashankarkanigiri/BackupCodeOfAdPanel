...
//                   </TouchableOpacity>
// <Text style={step3Styles.headerTitle}>
// {selectedSection !== null ? `Section ${selectedSection + 1}` : "Section"}
// </Text>
//                   <View style={{ width: 28 }} />
//                 </View>
...
//                       const updated = [...floors];
//                       if (
//   updated[selectedFloor] &&
//   updated[selectedFloor].sections &&
//   updated[selectedFloor].sections[selectedSection]
// ) {
...
// Here Commerical space added section
...
// here added add button in floor 
